<?php
	...
	cacheCtrlModule::validate('Wed, 4 Apr 2017 14:42:40 GMT');
...
//grp0
	...
	$r[0][0] = new stdClass;
	$r[0][0]->type = 'json';
	$r[0][0]->url = '/portfolio/';//putting these param in url for use with the post method
	...
	$r[0][0]->param = 'option=com_content&view=categories&format=ajax';

(function() {
	include('script', '/shared/jss/bsc_twn.js', undefined, undefined, function() {
		function wrt_bg_onload() {
			function menu_init() {
				var mi_crtPg = document.getElementById('menu-crt-itm'); //menu item_current page

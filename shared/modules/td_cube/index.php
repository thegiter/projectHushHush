<?php
	...
	cacheCtrlModule::validate('Tue, 21 Apr 2016 14:42:40 GMT');
...
//grp0
	...
	$r[0][0] = new stdClass;
	$r[0][0]->type = 'link';
	$r[0][0]->url = '/shared/modules/td_cube/csss/tc.css';
//grp1
	$r[1] = [];

	$r[1][0] = new stdClass;
	$r[1][0]->type = 'script';
	$r[1][0]->url = '/shared/modules/td_cube/jss/tc.js';

<?php
	...
	cacheCtrlModule::validate('Thu, 31 Mar 2017 14:42:40 GMT');
...
//grp0
    ...
    $r[0][0] = new stdClass;
	$r[0][0]->type = 'link';
	$r[0][0]->url = '/shared/modules/charts/csss/charts.css';
//grp1
	$r[1] = [];

    $r[1][0] = new stdClass;
	$r[1][0]->type = 'script';
	$r[1][0]->url = '/shared/modules/charts/jss/charts.js';

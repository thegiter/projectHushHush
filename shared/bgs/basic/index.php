<?php
	...
	cacheCtrlModule::validate('Sun, 25 Jul 2015 17:42:40 GMT');
...
//grp0
	...
	$r[0][0] = new stdClass;
	$r[0][0]->type = 'img';
	$r[0][0]->url = '/shared/bgs/basic/imgs/bg_ptn.jpg';
//grp1
	$r[1] = [];
	...
	$r[1][0] = new stdClass;
	$r[1][0]->type = 'link';
	$r[1][0]->url = '/shared/bgs/basic/csss/bg.css';
//grp2
	$r[2] = [];
...
//grp3
	...
	$r[3][0] = new stdClass;
	$r[3][0]->type = 'script';
	$r[3][0]->url = '/shared/bgs/basic/jss/bg.js';

...
(function() {
	...
	teo.addCss('/shared/bgs/basic/csss/bg.css');
	teo.addImgs('/shared/bgs/basic/imgs//*replace*/.jpg', ['bg_ptn']);
	
	teo.useDefault = false;
	
	teo.start();

	shpsAjax.hooks['basic_bg'] = function(cpnName) {//component name is used to uniquely identify the component
		shpsAjax.cpnList[cpnName].obj = {};

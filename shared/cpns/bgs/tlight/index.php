<?php
	...
	cacheCtrlModule::validate('Sun, 15 Apr 2017 14:42:40 GMT');
...
//grp0
	...
	$r[0][0] = new stdClass;
	$r[0][0]->type = 'img';
	$r[0][0]->url = '/shared/cpns/bgs/tlight/imgs/bg_ptn.png';
//grp1
	$r[1] = [];
	...
	$r[1][0] = new stdClass;
	$r[1][0]->type = 'link';
	$r[1][0]->url = '/shared/cpns/bgs/tlight/csss/bg.css';
//grp2
	$r[2] = [];
	...
	require root.'shared/cpns/bgs/tlight/html.php';
...
//grp3
	...
	$r[3][0] = new stdClass;
	$r[3][0]->type = 'script';
	$r[3][0]->url = '/shared/cpns/bgs/tlight/jss/bg.js';

...
//grp0
	...
	$r[0][0] = new stdClass;
	$r[0][0]->type = 'img';
	$r[0][0]->url = '/shared/cpns/beta_sign/imgs/beta_sticker.png';
//grp1
	$r[1] = [];

	$r[1][0] = new stdClass;
	$r[1][0]->type = 'link';
	$r[1][0]->url = '/shared/cpns/beta_sign/csss/bs.css';
//grp2
	$r[2] = [];
	...
	require root.'shared/cpns/beta_sign/html.php';
...
//grp3
	...
	$r[3][0] = new stdClass;
	$r[3][0]->type = 'script';
	$r[3][0]->url = '/shared/cpns/beta_sign/jss/bs.js';

...
class PlgContentPagebreak extends JPlugin
{
	...
	protected function _createNavigation(&$row, $page, $n)
	{
		...
		$row->pageNav = '<nav id="pb-nav-cnr">' . $prev . $next . '</nav>';
		
		$doc = JFactory::getDocument();
		
		$doc->addStyleSheet(root.'portfolio/plugins/content/pagebreak/csss/pb.css');
		
		$doc->addScript(root.'portfolio/plugins/content/pagebreak/jss/pb.js');
	}
}
